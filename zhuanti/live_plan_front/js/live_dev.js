...
var flashObj = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="640" height="360" id="cc_5E946960B809B48A9C33DC5901307461">' +
  ...
  '<embed src="https://p.bokecc.com/flash/single/1FD0DBA31FA2C2B1_F6E13AEE5F22977E9C33DC5901307461_true_D2BF717CCFB3408C_1/player.swf" width="640" height="360" name="cc_5E946960B809B48A9C33DC5901307461"' +
  'allowFullScreen="true" wmode="transparent" allowScriptAccess="always" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"/>' +
  '</object>';

var playerState = "close";
...
function on_cc_player_init( vid, objectID ){
  ...
  var config = {
    on_player_start: "on_v1_player_start",
    on_player_stop: "on_v1_player_stop",
  };
  v1 = player;
  player.setConfig(config);
}

function on_v1_player_start(){
  v1.seek(0);
}

function on_v1_player_stop(){
  $('#liveppt_background').html('');
}
  ...
  var channel = GS.createChannel("videogroup");
    ...
    function repalceColor(str, color) {
        if(str.indexOf('#000000')!=-1){
            return str.replace('#000000', color);
        }
        return str;
    }
    ...
    channel.bind("onPublicChat", function (event) {
        ...
        var sender_richtext = event.data.richtext?event.data.richtext:event.data.content;
        sender_richtext = repalceColor(sender_richtext, '#ff8000');
