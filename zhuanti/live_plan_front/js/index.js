...
$(function(){
	...
	$(".list a").bind("click",function(){
		$(".qgfx .cur a").attr("value",$(this).attr("value"));
		$(".qgfx .cur a").html($(this).html());
	...
	//课程分类筛选
	$(".class_fl li:nth-child(1) a").bind("click",function(){
		$(".class_fl li:nth-child(1) .current").removeClass();
		$(this).addClass("current");
		dosub();
	});
	
	//考试类型筛选
	$(".class_fl li:nth-child(2) a").bind("click",function(){
		$(".class_fl li:nth-child(2) .current").removeClass();
		$(this).addClass("current");
		dosub();
	});
	
	//课程班型筛选
	$(".class_fl li:nth-child(3) a").bind("click",function(){
		$(".class_fl li:nth-child(3) .current").removeClass();
		$(this).addClass("current");
		dosub();
	});
	...
	function dosub(){
		...
		$("input[name='NetClassCategoryId']").val($(".class_fl li:nth-child(1) .current").attr("value"));
		$("input[name='ClassType']").val($(".class_fl li:nth-child(3) .current").attr("value"));
		$("input[name='Province']").val($(".qgfx .cur a").attr("value"));
		$("input[name='examtype']").val($(".class_fl li:nth-child(2) .current").attr("value"));
