        ...
        success: function(data){
            ...
            if (data.on) {
                $.each(data.on,function(key,value){
                    ...
                    $(".livelist ul").append("<li class='on_zb'><span><em>"+value.start_time+"</em>-"+value.end_time+"</span><a href='?vodUrl="+value.replay_id+"&secret="+value.secret+"'>观看录播</a><p>"+value.title+"</p></li>");
                    else if (url == value.room_id && !value.replay_id)
                    $(".livelist ul").append("<li class='on_zb'><span><em>"+value.start_time+"</em>-"+value.end_time+"</span><a href='?liveUrl="+value.room_id+"&secret="+value.secret+"'>正在直播</a><p>"+value.title+"</p></li>");
                    else if(value.room_id && value.replay_id)
                    $(".livelist ul").append("<li class='zbing'><span><em>"+value.start_time+"</em>-"+value.end_time+"</span><a href='?vodUrl="+value.replay_id+"&secret="+value.secret+"'>观看录播</a><p>"+value.title+"</p></li>");
                    else
                    $(".livelist ul").append("<li class='zbing'><span><em>"+value.start_time+"</em>-"+value.end_time+"</span><a href='?liveUrl="+value.room_id+"&secret="+value.secret+"'>正在直播</a><p>"+value.title+"</p></li>");
                });
            }
            if (data.no) {
