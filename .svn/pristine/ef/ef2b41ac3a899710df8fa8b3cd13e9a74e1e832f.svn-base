        ...
        success: function(data){
            ...
            if (data.over) {
                $.each(data.over,function(key,value){
                    ...
                    $(".livelist ul").append("<li class='on_zb'><p>"+value.title+"</p><span><em>"+value.start_time+"</em>-"+value.end_time+"</span><a href='?vodUrl="+value.replay_id+"&secret="+value.secret+"'>观看录播</a></li>");
                    else
                    $(".livelist ul").append("<li class='over_zb'><p>"+value.title+"</p><span><em>"+value.start_time+"</em>-"+value.end_time+"</span><a href='?vodUrl="+value.replay_id+"&secret="+value.secret+"'>观看录播</a></li>");
                });
            }
            if (data.on) {
                $.each(data.on,function(key,value){
                    if (url == value.room_id)
                    $(".livelist ul").append("<li class='on_zb'><p>"+value.title+"</p><span><em>"+value.start_time+"</em>-"+value.end_time+"</span><a href='?liveUrl="+value.room_id+"&secret="+value.secret+"'>正在直播</a></li>");
                    else
                    $(".livelist ul").append("<li class='zbing'><p>"+value.title+"</p><span><em>"+value.start_time+"</em>-"+value.end_time+"</span><a href='?liveUrl="+value.room_id+"&secret="+value.secret+"'>正在直播</a></li>");
                });
            }
            if (data.no) {
