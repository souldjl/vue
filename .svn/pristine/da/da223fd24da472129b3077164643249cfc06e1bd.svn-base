$(function () {
    ...
    channel.bind("onStop", function () {
        //$(".talk_list ul").append("<li><span style='float:left'><a href='javascript:;' senderid='' style='FONT-SIZE: 10pt; FONT-WEIGHT: normal; COLOR: #ff8000; FONT-STYLE: normal' >系统提示</a>：</span>&nbsp;<span style='FONT-SIZE: 10pt; FONT-WEIGHT: normal; COLOR: #ff8000; FONT-STYLE: normal'>直播已结束！ <a href='./index3_lb.php' style='text-decoration:underline;'>点击刷新</a></span></li>");
