...
$update_sql = "UPDATE live_plan SET title=':title',date=':date',start_time=':start_time',end_time=':end_time',room_id=':room_id',secret=':secret',addtime=':addtime',type=':type',replay_id=':replay_id' where id = $id";
